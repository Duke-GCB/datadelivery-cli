...
class CommandsTestCase(TestCase):
    ...
    def test_deliver_bucket(self, mock_s3, mock_config_file):
        ...
        mock_s3_object.get_user_by_email.return_value = mock_to_user
        ...
        commands.deliver(bucket_name='some_bucket', email='joe@joe.com', user_message='Test')

        mock_s3.assert_called_with(self.config, user_agent_str='datadelivery/1.0')
        mock_s3_object.get_user_by_email.assert_called_with('joe@joe.com')
        ...
        mock_s3_object.send_delivery.assert_called_with(mock_delivery)
